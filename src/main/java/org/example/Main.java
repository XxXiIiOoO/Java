...
public class Main {
    ...
    public static void proverkaSovershennoletiya() {
        System.out.println("Пиривет! черканите количество людей для проверки:");//не знал как реализовать массивы, поэтому сделал возможность написать больше 1 человека
